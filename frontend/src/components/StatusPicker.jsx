const OPTS = [
  ['Планируется', 'bg-neutral-600'],
  ['Активно', 'bg-neutral-600'],
        ...
        return (
          <button
            ...
            className={`flex items-center justify-center gap-1.5 px-1.5 py-2 rounded-md text-[13px] font-medium transition ${
              active ? 'bg-white shadow-sm text-neutral-900 ring-1 ring-neutral-200' : 'text-neutral-500 hover:text-neutral-800'
            }`}
          >
